...
public class RecyclerListView extends RecyclerView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (fastScroll != null) {
            ...
            fastScroll.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132), View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(height, View.MeasureSpec.EXACTLY));
        }
    }
                    ...
                    if (sectionsAdapter != null) {
                        ...
                        if (sectionsType == 1) {
                            ...
                            if (currentFirst != startSection || pinnedHeader == null) {
                                ...
                                pinnedHeader.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), View.MeasureSpec.UNSPECIFIED));
    ...
    private void ensurePinnedHeaderLayout(View header, boolean forceLayout) {
        ...
        if (header.isLayoutRequested() || forceLayout) {
            if (sectionsType == 1) {
                ...
                int heightSpec = View.MeasureSpec.makeMeasureSpec(layoutParams.height, View.MeasureSpec.EXACTLY);
